...
```
# fork 请在gitlab管理面板操作，此处假定已经完成了fork。
...
# 创建特性分支f
git checkout origin/master -b 'bug名称'
...
合并完后 需要提交代码到该分支 git push fxzq name -f
#若是有冲突 先解决冲突
 git add .
 git rebase --continue
#查看分支
...
#删除分支 
git branch -D 'name'
git push example new-feature -f
